"""Avc Bit Reading Request/Response messages."""

__all__ = [
    "AvcReadBitsResponseBase",
    "AvcReadDiscreteInputsRequest",
    "AvcReadDiscreteInputsResponse",
]
...
class AvcReadBitsRequestBase(ModbusRequest):
...
class AvcReadBitsResponseBase(ModbusResponse):
...
class AvcReadDiscreteInputsRequest(AvcReadBitsRequestBase):
    ...
    def __init__(self, address=None, count=None, slave=0, **kwargs):
        ...
        :param slave: Modbus slave slave ID
        """
        AvcReadBitsRequestBase.__init__(self, address, count, slave, **kwargs)
    ...
    def execute(self, context):
        ...
        if isinstance(values, ExceptionResponse):
            return values
        return AvcReadDiscreteInputsResponse(values)


class AvcReadDiscreteInputsResponse(AvcReadBitsResponseBase):
    ...
    def __init__(self, values=None, slave=0, **kwargs):
        ...
        :param slave: Modbus slave slave ID
        """
        AvcReadBitsResponseBase.__init__(self, values, slave, **kwargs)
